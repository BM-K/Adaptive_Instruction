...
class ConformerBlock(nn.Module):
    ...
    def forward(self, inputs, enc_self_attn_mask):
        ...
        result = self.multiHeadAttn(result, mask=enc_self_attn_mask)
...
class my_conformer_encoder(nn.Module):
    """
    ...
    def __init__(
        ...
        super(my_conformer_encoder, self).__init__()
    ...
    def forward(self, inputs: Tensor, enc_self_attn_mask):
        """
